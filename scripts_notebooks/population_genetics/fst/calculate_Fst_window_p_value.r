...
# fst <- list(East=fst_East, West=fst_West)
...
# phenotype.column <- 'control_phase.moving.Fst'
 phenotype.column <- 'Location.moving.Fst'
...
#get pos of filtered peaks
pre_dt <- filtered.tables$pre[, .(window.chrom, window.pos,Location.moving.Fst, window.p, filter)]
fwrite(pre_dt, file = 'pre_east_west_fst_sig_windows.csv', sep = ',')
